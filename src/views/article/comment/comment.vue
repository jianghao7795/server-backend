    ...
    <div class="search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter.native="onSubmit">
        <el-form-item label="文章：">
          <el-select style="width: 150px" v-model="searchInfo.articleId" :multiple="false" filterable remote clearable
            reserve-keyword placeholder="请输入" :remote-method="searchArticle" :loading="loading">
