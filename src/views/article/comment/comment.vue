  ...
  <div>
    <div class="search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter.native="onSubmit">
        <el-form-item label="文章：">
          <el-select style="width: 150px" v-model="searchInfo.articleId" :multiple="false" filterable remote clearable reserve-keyword placeholder="请输入" :remote-method="searchArticle" :loading="loading">
    ...
    <el-dialog :model-value="dialogFormVisible" :before-close="closeDialog" :title="!formData.articleId ? '创建评论' : '更新评论'">
      <el-form :model="formData" label-position="right" label-width="80px">
        <el-form-item label="文章:">
          <el-select v-model="formData.article_id" :multiple="false" filterable remote clearable style="width: 100%" reserve-keyword placeholder="请输入" :remote-method="searchArticle" :loading="searchLoading">
...
const updateCommentFunc = async (row) => {
  ...
  if (res.code === 200) {
    ...
    options.value = [res.data.article];
