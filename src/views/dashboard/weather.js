...
const amapKey = "20b275679ce09dc305e93ea8c0aaf1f3";
...
const getWeather = async (code) => {
  const response = await axios.get("https://restapi.amap.com/v3/weather/weatherInfo?key=" + amapKey + "&extensions=all&city=" + code);
